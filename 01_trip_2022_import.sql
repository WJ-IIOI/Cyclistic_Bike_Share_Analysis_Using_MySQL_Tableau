...
SELECT MAX(month(started_at)) AS date_month, count(*) 
FROM bike_share_2023_07.trip_202201
UNION ALL
SELECT MAX(month(started_at)) AS date_month, count(*) 
FROM bike_share_2023_07.trip_202202
UNION ALL
SELECT MAX(month(started_at)) AS date_month, count(*) 
FROM bike_share_2023_07.trip_202203
UNION ALL
SELECT MAX(month(started_at)) AS date_month, count(*) 
FROM bike_share_2023_07.trip_202204
UNION ALL
SELECT MAX(month(started_at)) AS date_month, count(*) 
FROM bike_share_2023_07.trip_202205
UNION ALL
SELECT MAX(month(started_at)) AS date_month, count(*) 
FROM bike_share_2023_07.trip_202206
UNION ALL
SELECT MAX(month(started_at)) AS date_month, count(*) 
FROM bike_share_2023_07.trip_202207
UNION ALL
SELECT MAX(month(started_at)) AS date_month, count(*) 
FROM bike_share_2023_07.trip_202208
UNION ALL
SELECT MAX(month(started_at)) AS date_month, count(*) 
FROM bike_share_2023_07.trip_202209
UNION ALL
SELECT MAX(month(started_at)) AS date_month, count(*) 
FROM bike_share_2023_07.trip_202210
UNION ALL
SELECT MAX(month(started_at)) AS date_month, count(*) 
FROM bike_share_2023_07.trip_202211
UNION ALL
SELECT MAX(month(started_at)) AS date_month, count(*) 
FROM bike_share_2023_07.trip_202212;
